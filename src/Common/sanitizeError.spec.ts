...
describe("sanitizeError", () => {
  ...
  it("strips sensistive values from config in the error passed in it", () => {
    ...
    const hookUrl =
      "https://hooks.slack.com/services/T06SD45654/RD45642/ABDaZ894521321";
    let error = new AppError(
      400,
      `Bad thing occured. AccessToken was ${recruiteeAT}`
    ...
    expect(sanitizedError.message).toEqual(
      `Bad thing occured. AccessToken was [REDACTED]`
    );
